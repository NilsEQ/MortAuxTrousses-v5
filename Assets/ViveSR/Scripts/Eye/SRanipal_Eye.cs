    ...
    namespace anipal
    {
        namespace Eye
        {
            public static class SRanipal_Eye
            {
                ...
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, float radius, float maxDistance, int focusableLayer, EyeData eye_data, Camera mycamera)
                {
                    bool valid = GetGazeRay(index, out ray, eye_data);
                    if (valid)
                    {
                        Ray rayGlobal = new Ray(mycamera.transform.position, mycamera.transform.TransformDirection(ray.direction));
                        RaycastHit hit;
                ...
                /// <param name="focusableLayer">A layer id that is used to selectively ignore object.</param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, float radius, float maxDistance, int focusableLayer, Camera mycamera)
                {
                    UpdateData();
                    return Focus(index, out ray, out focusInfo, radius, maxDistance, focusableLayer, EyeData_, mycamera);
                }
                ...
                /// <param name="eye_data">ViveSR.anipal.Eye.EyeData. </param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, float radius, float maxDistance, EyeData eye_data, Camera mycamera)
                {
                    return Focus(index, out ray, out focusInfo, radius, maxDistance, -1, eye_data, mycamera);
                }
                ...
                /// <param name="maxDistance">The max length of the ray.</param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, float radius, float maxDistance, Camera mycamera)
                {
                    UpdateData();
                    return Focus(index, out ray, out focusInfo, radius, maxDistance, EyeData_,mycamera);
                }
                ...
                /// <param name="eye_data">ViveSR.anipal.Eye.EyeData. </param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, float maxDistance, EyeData eye_data, Camera mycamera)
                {
                    return Focus(index, out ray, out focusInfo, 0, float.MaxValue, -1, eye_data, mycamera);
                }
                ...
                /// <param name="maxDistance">The max length of the ray.</param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, float maxDistance, Camera mycamera)
                {
                    UpdateData();
                    return Focus(index, out ray, out focusInfo, maxDistance, EyeData_, mycamera);
                }
                ...
                /// <param name="eye_data">ViveSR.anipal.Eye.EyeData. </param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, EyeData eye_data, Camera mycamera)
                {
                    return Focus(index, out ray, out focusInfo, 0, float.MaxValue, -1, eye_data, mycamera);
                }
                ...
                /// <param name="focusInfo">Information about where the ray focused on.</param>
                /// <returns>Indicates whether the ray hits a collider.</returns>
                public static bool Focus(GazeIndex index, out Ray ray, out FocusInfo focusInfo, Camera mycamera)
                {
                    UpdateData();
                    return Focus(index, out ray, out focusInfo, EyeData_, mycamera);
                }
