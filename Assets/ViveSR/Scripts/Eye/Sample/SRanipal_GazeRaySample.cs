        ...
        namespace Eye
        {
            public class SRanipal_GazeRaySample : MonoBehaviour
            {
                ...
                private void Update()
                {
                    ...
                    Vector3 GazeDirectionCombined = mycamera.transform.TransformDirection(GazeDirectionCombinedLocal);
                    GazeRayRenderer.SetPosition(0, mycamera.transform.position - mycamera.transform.up * 0.05f);
                    GazeRayRenderer.SetPosition(1, mycamera.transform.position + GazeDirectionCombined * LengthOfRay);
                }
