...
public class Data_writer_Hitchcock : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        path = Application.dataPath + "/Data/" + DateTime.Now.ToString("dd-MM-yy   hh-mm-ss") + " - Hitchcock";
    ...
    {
        Debug.Log(global_timer.ToString().Replace(',', '.') + "," + RigName);
        writer_Cuts.WriteLine(global_timer.ToString().Replace(',', '.') + "," + RigName);
        writer_Cuts.Flush();
    }
